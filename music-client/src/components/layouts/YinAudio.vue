<template>
  <audio :src="currentMusic" controls="controls" :ref="player" preload="true" @canplay="canplay" @timeupdate="timeupdate" @ended="ended">
...
export default defineComponent({
  setup() {
    ...
    const currentMusic = computed(() => store.getters.songUrl); // 音乐链接
