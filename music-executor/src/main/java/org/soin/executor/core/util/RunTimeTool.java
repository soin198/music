package org.soin.executor.core.util;
...
public class RunTimeTool {
     ...
     * @param params     入参参数
     */
    public static void printMethodMsg(String methodName, String message, Object... params) {
     ...
     * @param params     入参参数
     */
    public static void printMethodMsgOther(String methodName, String message, Object[] params) {
        LOGGER.info("请求方法：{}，{}，请求参数：{}", methodName, message, JSONObject.toJSONString(params));
    }
